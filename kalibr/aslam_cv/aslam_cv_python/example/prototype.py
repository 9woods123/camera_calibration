...
left  = cv2.imread('im_left.jpg',  cv2.IMREAD_GRAYSCALE)
front = cv2.imread('im_front.jpg', cv2.IMREAD_GRAYSCALE)
right = cv2.imread('im_right.jpg', cv2.IMREAD_GRAYSCALE)
rear  = cv2.imread('im_rear.jpg',  cv2.IMREAD_GRAYSCALE)
